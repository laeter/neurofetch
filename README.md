...
- **ASCII Art**: [fetch-sama](https://github.com/c-error/fetch-sama) by c-error - All Neuro family & friends ASCII art (Neurosama, EvilNeuro, Vedal, Anny, Aquwa, Imp, Camimi, Cog) with RGB color palettes
