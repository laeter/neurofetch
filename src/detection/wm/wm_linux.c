...
static const char* getHyprland(FFstrbuf* result)
{
    ...
    FF_DEBUG("Checking for " NEUROFETCH_TARGET_DIR_USR "/include/hyprland/src/version.h" " file");
    if (ffReadFileBuffer(NEUROFETCH_TARGET_DIR_USR "/include/hyprland/src/version.h", result))
    {
